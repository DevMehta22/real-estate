  ...
  const plans = [
    {
      ...
      features: [
        "Enjoy the Amazing service of AI-powered price prediction 5 times a month"
      ],
    },
    {
        name: "Standard",
        ...
        frequency: "Every Month",
        features: [
          "Enjoy the Amazing service of AI-powered price prediction 15 times a month"
        ],
      },
    {
      name: "Elite",
      ...
      frequency: "Every Month",
      features: [
        "Enjoy the Amazing service of AI-powered price prediction unlimited times."
      ],
    },
  ];
